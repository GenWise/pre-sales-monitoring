 ...
 * Deploy this script specifically to ats_qualifiers: 1M3hRWVqCZbF1DhVGuFAzh68pWbLxyF9BZd_ShDrRzKg
 *
...
const FORM_CONFIG = {
    ...
    fieldMapping: {
        // EXACT field names from ats_qualifiers form
...
function testIntegration() {
    try {
        console.log('🧪 Testing ats_qualifiers integration... VERSION 2025-10-05-00:15');

        const sampleData = {
            'Child Name': 'Test ATS Child',
            'Parent Name': 'Test ATS Parent',
            'Parent Email Id': 'test@ats.com',
