...
/**
 * Google Apps Script for Form: returning_students
...
function onFormSubmit(e) {
  console.log('📝 Form submission detected for returning_students');
...
function setupFormTrigger() {
  try {
    console.log('⚡ Setting up form submit trigger for returning_students...');
