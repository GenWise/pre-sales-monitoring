/**
 * FORM-BOUND Google Apps Script for ats_qualifiers
...
function onFormSubmit(e) {
  console.log('📝 ats_qualifiers submission detected');
...
function mapInterestLevel(response) {
  ...
  // ats_qualifiers specific mappings
  const mappings = {
    'urgent': 'High',
    'high priority': 'High',
...
function testWebhook() {
  console.log('🧪 Testing webhook connectivity for ats_qualifiers...');

  const testPayload = {
    formData: {
      'Child Name': 'Test Child ats_qualifiers',
      'Parent Name': 'Test Parent ats_qualifiers',
      'Parent Email': 'test@form2.com',
...
function getStatus() {
  try {
    ...
    console.log('📊 ats_qualifiers Status:', JSON.stringify(status, null, 2));
    return status;
