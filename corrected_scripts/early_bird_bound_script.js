/**
 * FORM-BOUND Google Apps Script for early_bird
...
function onFormSubmit(e) {
  console.log('📝 early_bird submission detected');
...
function testWebhook() {
  console.log('🧪 Testing webhook connectivity for early_bird...');

  const testPayload = {
    formData: {
      'Child Name': 'Test Child early_bird',
      'Parent Name': 'Test Parent early_bird',
      'Parent Email': 'test@form4.com',
...
function getStatus() {
  try {
    ...
    console.log('📊 early_bird Status:', JSON.stringify(status, null, 2));
    return status;
