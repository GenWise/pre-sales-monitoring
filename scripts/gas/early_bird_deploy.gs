 ...
 * Deploy this script specifically to early_bird: 1IJVMLXOThuQE8WVI4bYiruJrTyxsznTomotkS2rfyYY
 *
...
// FORM4 CONFIGURATION - DO NOT CHANGE
...
const FORM4_CONFIG = {
    ...
    // FORM4 SPECIFIC INTEREST LEVEL MAPPINGS
...
function onFormSubmit(e) {
    try {
        ...
        const mappedData = mapFormResponse(formData, FORM4_CONFIG);
...
function mapFormResponse(formResponse, formConfig) {
    ...
    // Apply early_bird specific interest level mapping
...
function testIntegration() {
    try {
        ...
        // Map the data
        const mappedData = mapFormResponse(sampleData, FORM4_CONFIG);
