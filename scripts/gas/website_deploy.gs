...
// FORM3 CONFIGURATION - DO NOT CHANGE
...
const FORM3_CONFIG = {
    ...
    // FORM3 SPECIFIC INTEREST LEVEL MAPPINGS
...
function onFormSubmit(e) {
    try {
        ...
        const mappedData = mapFormResponse(formData, FORM3_CONFIG);
...
function testIntegration() {
    try {
        ...
        // Map the data
        const mappedData = mapFormResponse(sampleData, FORM3_CONFIG);
