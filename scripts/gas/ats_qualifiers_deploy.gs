...
// FORM2 CONFIGURATION - DO NOT CHANGE
...
const FORM2_CONFIG = {
    ...
    // FORM2 SPECIFIC INTEREST LEVEL MAPPINGS
...
function onFormSubmit(e) {
    try {
        ...
        const mappedData = mapFormResponse(formData, FORM2_CONFIG);
...
function testIntegration() {
    try {
        ...
        // Map the data
        const mappedData = mapFormResponse(sampleData, FORM2_CONFIG);
