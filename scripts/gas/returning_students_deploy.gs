...
// FORM1 CONFIGURATION - DO NOT CHANGE
...
const FORM1_CONFIG = {
    ...
    // FORM1 SPECIFIC INTEREST LEVEL MAPPINGS
...
function onFormSubmit(e) {
    try {
        ...
        const mappedData = mapFormResponse(formData, FORM1_CONFIG);
...
function testIntegration() {
    try {
        ...
        // Map the data
        const mappedData = mapFormResponse(sampleData, FORM1_CONFIG);
